...
export const MENU_ITEMS = [
  {text: "Tổng quan", iconCoordinates: [29, 1628], activeClass:'dashboard_icon__active', route: '/tong-quan'},
  {text: "Tiền mặt", iconCoordinates: [73, 1629], activeClass:'cash_icon__active', route: '/nhan-vien'} ,
  {text: "Tiền gửi", iconCoordinates: [117, 1630], activeClass:'deposit_icon__active', route: '/tien-gui'},
  {text: "Mua hàng", iconCoordinates: [161, 1631], activeClass:'buy_icon__active', route: '/mua-hang'},
  {text: "Bán hàng", iconCoordinates: [206,1628], activeClass:'sell_icon__active', route: '/ban-hang'},
  {text: "Quản lý hoá đơn", iconCoordinates: [249,1629], activeClass:'bill_icon__active', route: '/quan-ly-hoa-don'},
  {text: "Kho", iconCoordinates: [291,1630], activeClass:'warehouse_icon__active', route: '/kho'},
  {text: "Công cụ dụng cụ", iconCoordinates: [336,1630], activeClass:'tool_icon__active', route: '/cong-cu-dung-cu'},
  {text: "Tài sản cố định", iconCoordinates: [380,1630], activeClass:'static_asset_icon__active', route: '/tai-san-co-dinh'},
  {text: "Tiền lương", iconCoordinates: [471,1661], activeClass:'salary_icon__active', route: '/tien-luong'},
  {text: "Thuế", iconCoordinates: [425,1631], activeClass:'tax_icon__active', route: '/thue'},
  {text: "Giá thanh", iconCoordinates: [470,1630], activeClass:'price_icon__active', route: '/gia-thanh'},
  {text: "Tổng hợp", iconCoordinates: [514,1629], activeClass:'summary_icon__active', route: '/tong-hop'},
  {text: "Ngân sách", iconCoordinates: [381,1659], activeClass:'budget_icon__active', route: '/ngan-sach'},
  {text: "Báo cáo", iconCoordinates: [551,1631], activeClass:'report_icon__active', route: '/bao-cao'},
  {text: "Phân tích tài chính", iconCoordinates: [207,1664], activeClass:'analyze_icon__active', route: '/phan-tich-tai-chinh'}
]
...
export const DEPARTMENT_DATA = [
  {
    ...
    "Description": "Dolor sed enim repellat. Qui quo atque. Omnis delectus sunt non. Tempora maiores enim reprehenderit tenetur. Impedit modi inventore. Eum porro omnis...",
  ...
  },
  {
    ...
    "Description": "Dolore suscipit est ipsa. Suscipit voluptas et omnis. Iste sed distinctio ab sint. Deleniti eius ea? Sunt labore vel; ut eum dolorem.",
  ...
  },
  {
    ...
    "Description": "Et modi reprehenderit. Vero est sed alias voluptatem nostrum facilis! Iste voluptatem magni impedit temporibus odit ducimus.",
  ...
  },
  {
    ...
    "Description": "Impedit beatae aspernatur dignissimos voluptatem et in. Eum nisi nostrum quidem ullam fugiat eum.",
...
export const POSITION_DATA = [
  ...
  },
  {
    ...
    "Description": "Voluptates iste repudiandae; consequatur aut fuga facilis omnis; ipsa ut veritatis dolor aliquam ducimus sed? Quod sapiente quo. Veritatis rerum nisi. Unde.",
    "ParentId": null,
